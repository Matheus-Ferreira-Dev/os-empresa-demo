...
Quando o usuário pedir uma nova capacidade, escreva primeiro uma proposta em `skills/propostas/<slug>.md` com problema, gatilho, entradas, saídas, limites, exemplos e dependências. Só crie `.claude/skills/<slug>/SKILL.md` após aprovação explícita.
